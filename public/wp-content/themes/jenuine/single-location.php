 ...
 * Post Template
 *
 * This template is loaded when browsing a Location Custom Post Type created by Events Manager WordPress plugin.
 *
 * @package FitPro
 * @subpackage Template
 */
                ...
                while (have_posts()) :
                    ...
                    <article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
                        ...
                        <div class="entry-content clearfix">
                            ...
                            echo '<div class="location-details info-section">';
