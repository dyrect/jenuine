    ...
    class MO_SidebarManager {
        ...
        private function init_sidebars() {
            $this->sidebar_names = array(
                ...
                'primary-trainers' => __('Trainers Sidebar', 'mo_theme'),
                'primary-classes' => __('Classes Sidebar', 'mo_theme'),
                'primary-features' => __('Features Sidebar', 'mo_theme'),
            ...
            if (current_theme_supports('portfolio')) {
                $this->sidebar_names['primary-portfolio'] = __('Portfolio Sidebar', 'mo_theme');
            }
            ...
            $this->sidebar_descriptions = array(
                ...
                'primary-trainers' => __('Sidebar displayed in individual trainer pages', 'mo_theme'),
                'primary-classes' => __('Sidebar displayed in individual classes pages', 'mo_theme'),
                'primary-features' => __('Sidebar displayed in individual gym features pages', 'mo_theme'),
            ...
            if (current_theme_supports('portfolio')) {
                $this->sidebar_descriptions['primary-portfolio'] = __('Sidebar displayed in the Portfolio archive pages', 'mo_theme');
            }
        ...
        function get_sidebar_id_suffix() {
            ...
            if (current_theme_supports('portfolio') && (is_tax('portfolio_category') || is_post_type_archive('portfolio') || mo_is_portfolio_page()))
                $suffix = 'portfolio';
            elseif (is_tax('gallery_category') || is_post_type_archive('gallery_item') || mo_is_gallery_page())
                $suffix = 'gallery';
            elseif (is_post_type_archive('trainer') || is_singular('trainer') || is_page_template('template-trainers.php'))
                $suffix = 'trainers';
            elseif (is_post_type_archive('fitness_class') || is_singular('fitness_class') || is_page_template('template-classes.php'))
                $suffix = 'classes';
            elseif (is_post_type_archive('feature') || is_singular('feature') || is_page_template('template-features.php'))
                $suffix = 'features';
